...
#define TABLE_STEP_HALF_DELAY_uS 500
#define TABLE_STEPS_PER_ROTATION 3200
...
#define TOWER_STEP_HALF_DELAY_uS 50
#define TOWER_HEIGHT_IN_STEPS 45000
static_assert(TOWER_HEIGHT_IN_STEPS % TOWER_HEIGHT_STOPS == 0);
#define TOWER_STEPS_PER_STOP (TOWER_HEIGHT_IN_STEPS / TOWER_HEIGHT_STOPS)
